...
public class Calendars {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement roundTripRadioButton = driver
				.findElement(By.cssSelector("input[id='ctl00_mainContent_rbtnl_Trip_1']"));
		...
		destCity.click();
		Thread.sleep(2000);
		WebElement currentDay = driver.findElement(By.cssSelector(".ui-state-default.ui-state-highlight")); // locator
																											// for
																											// current
																											// day
		currentDay.click();
